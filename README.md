...
│    │  └─────────────────────────────────────────────┘   │                  │
│    │                                                     │                  │
│    │  outbound targets (plain TCP/HTTP — toy mocks)      │                  │
│    │  ┌─────────────┐  ┌──────────────┐  ┌──────────┐   │                  │
...
2. Issues leaf certs for: `test-client`, `f5-sim`, `haproxy`, `pod-a`, `pod-b`
3. Creates four Kubernetes Secrets in the `envoy-test` namespace:
...
├── scripts/
│   └── generate-certs.sh   self-signed CA + leaf certs + k8s secrets
├── Makefile
